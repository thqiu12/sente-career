...
export function Hero() {
  return (
    <section id="top" className="relative overflow-hidden bg-ink text-paper">
      ...
      <div className="relative mx-auto grid max-w-[1240px] items-center gap-12 px-5 pb-20 pt-28 sm:px-8 lg:grid-cols-[1.08fr_0.92fr] lg:gap-8 lg:pb-24 lg:pt-28">
        {/* text column — rendered visible on first paint (LCP-safe),
            entrance is CSS-only so it never depends on JS hydration */}
        <div className="max-w-xl">
          <div
            className="rise mb-7 flex items-center gap-3 text-[12.5px] font-semibold tracking-[0.16em] text-muted-d"
          ...
          <h1
            className="rise text-[clamp(2.6rem,7vw,4.6rem)] font-black leading-[1.04] tracking-[0.01em]"
          ...
          <p
            className="rise mt-7 max-w-md text-[17px] leading-relaxed text-[#cfccc0]"
          ...
          <p
            className="rise mt-9 text-[13px] tracking-[0.04em] text-muted-d"
